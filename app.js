...
angular.module('firmwareDownload', ['ngMaterial'])
  ...
  .controller('SelectCtrl', function($scope, $location){
    ...
    $scope.routers = [
      ...
      { id: "gl-inet-6408a-v1", name: "GL Inet 6408a Ver:1" },
      { id: "gl-inet-6416a-v1", name: "GL Inet 6416a Ver:1" },
      { id: "linksys-wrt160nl", name: "Linksys WRT 160 NL" },
      { id: "netgear-wndr3700", name: "NetGear WNDR 3700" },
      { id: "netgear-wndr3700v2", name: "NetGear WNDR 3700 Ver:2" },
      { id: "netgear-wndr3800", name: "NetGear WNDR 3800" },
      ...
      { id: "tp-link-tl-mr3220-v2", name: "TP-Link TL MR 3220 Ver:2" },
      { id: "tp-link-tl-mr3420-v1", name: "TP-Link TL MR 3420 Ver:1" },
      { id: "tp-link-tl-mr3420-v2", name: "TP-Link TL MR 3420 Ver:2" },
      { id: "tp-link-tl-wa701n-nd-v1", name: "TP-Link TL WA 701 N/ND Ver:1" },
      ...
      { id: "tp-link-tl-wa860re-v1", name: "TP-Link TL WA 860RE Ver:1" },
      { id: "tp-link-tl-wa901n-nd-v2", name: "TP-Link TL WA 901 N/ND Ver:2" },
      { id: "tp-link-tl-wa901n-nd-v3", name: "TP-Link TL WA 901 N/ND Ver:3" },
      ...
      { id: "tp-link-tl-wr2543n-nd-v1", name: "TP-Link TL WR 2543 N/ND Ver:1" },
      ...
      { id: "tp-link-tl-wr743n-nd-v1", name: "TP-Link TL WR 743 N/ND Ver:1" },
      { id: "tp-link-tl-wr743n-nd-v2", name: "TP-Link TL WR 743 N/ND Ver:2" },
      ...
      { id: "tp-link-tl-wr941n-nd-v5", name: "TP-Link TL WR 941 N/ND Ver:5" },
      { id: "ubiquiti-bullet-m", name: "Ubiquiti Bullet M" },
      { id: "ubiquiti-loco-m-xw", name: "Ubiquiti Loco M XW" },
      { id: "ubiquiti-nanostation-m-xw", name: "Ubiquiti Nanostation M XW" },
      { id: "ubiquiti-nanostation-m", name: "Ubiquiti Nanostation M" },
      { id: "ubiquiti-unifi-ap-pro", name: "Ubiquiti UniFi AP Pro" },
